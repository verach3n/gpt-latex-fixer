...
When exporting from GPT Deep Research, you can typically download multiple formats (MD/DOC/PDF). However, the Markdown export loses citation information, while the PDF retains complete references with titles and URLs. **This tool uses the companion PDF to restore the missing citation data in the Markdown file.**
